      ...
      {documentation.length === 0 ? (
        ...
        <ScrollView style={styles.scrollView}>
          {documentation.map((item) => (
            <View key={item.id} style={[styles.docRow, { borderBottomColor: theme.border }]}>
              ...
              <View style={styles.docRowActions}>
                ...
                >
                  <FontAwesome name="download" size={16} color={theme.textSecondary} />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.actionButton}
                  onPress={() => handleOpen(item)}
                >
                  <FontAwesome name="folder-open" size={16} color={theme.textSecondary} />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.actionButton}
